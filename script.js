...
document.addEventListener('DOMContentLoaded', () => {
    const elementsToAnimate = document.querySelectorAll('.section-title, .about-text, .contact-info, .skill-category, .project-card');
...
console.log(`
🚀 Welcome to Noé Boulud's Portfolio!
   ...
   Contact: noe.boulud@example.com
`);
